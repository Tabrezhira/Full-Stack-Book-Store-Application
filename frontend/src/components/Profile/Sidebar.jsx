  ...
  return (
    ...
    <div className=' flex items-center flex-col justify-center '>
      ...
      <div className='w-full flex-col items-center justify-center hidden lg:flex'>
        ...
        <Link to="/profile/orderHistory" className="text-zinc-100 font-semibold w-full py-2 mt-4 text-center hover:bg-zinc-900 rounded transition-all">
            Order History
        </Link>
        <Link to="/profile/Settings" className="text-zinc-100 font-semibold w-full py-2 mt-4 text-center hover:bg-zinc-900 rounded transition-all">
           Settings
        </Link>
      </div>
      }
      {role === 'admin' && 
            <div className='w-full flex-col items-center justify-center hidden lg:flex'>
             ...
             <Link to="/profile/add-book" className="text-zinc-100 font-semibold w-full py-2 mt-4 text-center hover:bg-zinc-900 rounded transition-all">
                Add Book
             </Link>
           </div>
      }
